                       ...
                       child:Column(
                         children:[
                           ...
                           Container(
                             ...
                             alignment:Alignment.centerLeft,
                             child:Text(snapshot.data![index].shopName.toString(),style: TextStyle(fontSize: 16,color:Colors.black,fontWeight: FontWeight.bold),),
                           ),

                           Container(
                             margin: EdgeInsets.all(2),
                             alignment:Alignment.centerLeft,
                             child:Text(snapshot.data![index].productName.toString(),style: TextStyle(fontSize: 16,color: Color(0xFF817373)),),
                           ),

                           Container(
                             margin: EdgeInsets.all(2),
                             alignment:Alignment.centerLeft,
                             child:Text("${snapshot.data![index].pieces.toString()} pieces",style: TextStyle(fontSize: 16,color: Color(0xFF817373)),),
                           ),
